...
public class SkillsetFighter : Skillset
{
    void OnEnable()
    {
        ...
        startingArmor = 5;
        startingSpeed = 12;
        primary = FindObjectOfType<ShootRight>();
        primary.manaCost = 5;
        primary.reloadtime = 1.5f;
        secondary = FindObjectOfType<ShootLeft>();
        secondary.manaCost = 5;
        secondary.reloadtime = 1.5f;
        alternative = FindObjectOfType<AltAttack>();
        alternative.manaCost = 75;
        alternative.reloadtime = 6f;
        skill = FindObjectOfType<UseShield>();
        skill.manaCost = 120;
        skill.reloadtime = 6f;
        ultimate = FindObjectOfType<UltAttack>();
