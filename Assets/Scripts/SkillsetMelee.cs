...
public class SkillsetMelee : Skillset
{
    void OnEnable()
    {
        ...
        startingArmor = 35;
        startingSpeed = 16;
        primary = FindAnyObjectByType<Melee>();
        primary.manaCost = 8;
        primary.reloadtime = 1f;
        secondary = FindAnyObjectByType<Parry>();
        secondary.manaCost = 10;
        secondary.reloadtime = 1f;
        alternative = FindAnyObjectByType<Dash>();
        alternative.manaCost = 15;
        alternative.reloadtime = 1f;
        skill = FindAnyObjectByType<Immolate>();
        skill.manaCost = 20;
        skill.reloadtime = 8f;
        ultimate = FindAnyObjectByType<UltBladeFlurry>();
